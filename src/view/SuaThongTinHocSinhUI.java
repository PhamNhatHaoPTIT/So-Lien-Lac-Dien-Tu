...
public class SuaThongTinHocSinhUI extends javax.swing.JFrame {

    public SuaThongTinHocSinhUI() {
        initComponents();
        txt_mahocsinh.setText(StaticVariable.GV_MAHS);
        txt_ho.setText(StaticVariable.GV_HOHS);
        txt_ten.setText(StaticVariable.GV_TENHS);
        ...
        if(StaticVariable.GV_GIOITINHHS) {
    ...
    private void initComponents() {
        ...
        setTitle("Sửa Thông Tin Học Sinh");
        setResizable(false);
    ...
    private void btn_luuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_luuActionPerformed
        if(txt_ho.getText().equals("") || txt_ten.getText().equals("")
           || txt_ngaysinh.isEnabled() == false || (nam.isSelected() == false && nu.isSelected() == false)) {
            ...
            StaticVariable.GV_HOHS = XuLiChuoi.chuanHoaChuoi(txt_ho.getText());
            StaticVariable.GV_TENHS = XuLiChuoi.chuanHoaChuoi(txt_ten.getText());
            if(nam.isSelected()) {
            ...
            StaticVariable.GV_NGAYSINHHS = new SimpleDateFormat("dd.MM.yyyy").format(d);
            int x = HocSinhDAO.suaThongTinHocSinh(StaticVariable.GV_MAHS);
            if(x == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaThongTinHocSinhUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuaThongTinHocSinhUI().setVisible(true);
            }
        });
    }
